<template>
  <aside class="menu app-sidebar animated" :class="{ slideInLeft: show, slideOutLeft: !show }">
    ...
    <ul class="menu-list">
      <li v-for="(item, index) in menu" v-show="!item.meta.notshowinlist">
        <router-link :to="'/main/' + item.path" :exact="true" :aria-expanded="isExpanded(item) ? 'true' : 'false'" v-if="item.path" @click.native="toggle(index, item)">
